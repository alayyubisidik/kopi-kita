...
<div class="max-w-7xl mx-auto flex flex-col gap-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex flex-col gap-1">
            <nav class="flex items-center gap-1 text-xs font-semibold" style="color:#4f453c;">
                ...
                <span class="material-symbols-outlined" style="font-size:14px;color:#81756b;">chevron_right</span>
                <span style="color:#7a582f;">Tambah Option Group</span>
            </nav>
            <h1 class="text-3xl font-extrabold tracking-tight" style="color:#221a13;">Tambah Option Group</h1>
            <p class="text-sm" style="color:#4f453c;">Buat kelompok opsi baru untuk kustomisasi produk menu.</p>
        </div>
    ...
    <div>
        <div class="rounded-2xl overflow-hidden" style="background:#fff;box-shadow:0 4px 14px -2px rgba(124,92,62,0.10);">
            <form novalidate method="POST" action="{{ route('dashboard.option-groups.store') }}" x-data="{ selectionType: '{{ old('selection_type', 'single') }}' }">
                @csrf
                ...
                <div class="p-6 flex flex-col gap-5">
                    ...
                    {{-- Wajib Dipilih --}}
                    <div class="flex items-center gap-3 p-4 rounded-xl" style="background:#fbebdf;">
                        @php $isRequired = old('is_required', true); @endphp
