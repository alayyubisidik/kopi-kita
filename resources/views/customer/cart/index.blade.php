...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @else
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <button type="button"
                class="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white px-5 py-3 rounded-md hover:bg-blue-700 transition-colors font-semibold text-sm cursor-not-allowed opacity-60"
                disabled>
