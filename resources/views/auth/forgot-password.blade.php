...
<head>
    ...
    <title>Lupa Password – Kopi Kita</title>
    <meta name="description" content="Reset password akun Admin & POS Kopi Kita.">
            ...
            <div class="relative w-full max-w-max-mobile-width flex flex-col items-center">
                ...
                <div class="w-full bg-surface-container-lowest rounded-xl p-space-lg shadow-xl shadow-primary-container/10 flex flex-col gap-space-lg relative overflow-hidden z-10">
                    ...
                    <div class="flex flex-col items-center text-center pt-space-xs">
                        ...
                        <h1 class="text-headline-lg font-headline-lg text-primary tracking-tight">Lupa Password</h1>
                    ...
                    {{-- Form --}}
                    <form id="forgotForm" method="POST" action="{{ route('password.email') }}" class="flex flex-col gap-space-md">
                        @csrf

                        {{-- Email --}}
                        <div class="flex flex-col gap-1.5">
                            <label for="email" class="text-label-lg font-label-lg text-on-surface">Email Admin</label>
                            <div class="relative flex items-center">
                                <span class="material-symbols-outlined text-on-surface-variant absolute left-3.5 pointer-events-none transition-colors duration-200" style="font-size:20px;">mail</span>
                        ...
                        <button id="submitBtn" type="submit"
                            ...
                            <span id="submitBtnText">Kirim Tautan Reset</span>
                        </button>
                    </form>

                    {{-- Back to login --}}
                    <div class="flex items-center justify-center">
                        <a href="{{ route('login') }}" class="inline-flex items-center gap-1.5 text-label-md font-label-md text-primary hover:text-secondary transition-colors">
